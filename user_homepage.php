      ...
      <button class="navbar-toggler nav-button" type="button" data-toggle="collapse" data-target="#myNavbar">
          ...
          <li>
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <li><a class="dropdown-item" href="user_profile.php?user_id={$row['user_id']}">Profile</a></li>
     ...
     <div class="container-fluid">
      ...
      <div class="row text-black text-center">
        <div class="col m-4">
          ...
          <p class="lead">
          These are examples of our past photobooth services, which have covered a range of events including birthdays, Valentine's celebrations, and weddings.</p>
    ...
    <div class="container-fluid">
      <div class="row text-dark py-4">
        <div class="col-lg-4 col-sm-6">
          ...
          <p class="small">We are Only Accepting Bookings From Batangas Areas and Cities near Batangas !<br><br>For Inquiries :<br> Call : 0000-000-0000</p>
        </div>
        ...
        <div class="col-lg-2 col-sm-6">
          ...
          <ul class="list-unstyled">
            <li>
              <a href="#" class="footer-link text-uppercase">Philippines</a>
            </li>
            <li>
              <a href="#" class="footer-link text-uppercase">Batangas City</a>
            </li>
            <li>
              <a href="#" class="footer-link text-uppercase">Bauan</a>
            </li>
            <li>
              <a href="#" class="text-info">rcsp@gmail.com</a>
            </li>
          </ul>
        </div>
        <div class="col-lg-4 col-sm-6" id="con">
          <h5 class="pb-3">Send us a Feedback</h5>
          <p class="small">Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque accusamus dolores iste praesentium assumenda est quia accusantium corrupti ipsam inventore.</p>
          <form class="mb-3">
            <div class="input-group">
              <input type="text" class="form-control" placeholder="FeedBack in Service">
              <div class="input-group-append">
                <button type="button" class="btn bg-danger text-black text-uppercase font-weight-bold">Send Feedback</button>
              </div>
            </div>
          </form>
          <ul class="list-inline">
            <a href="#"><li class="list-inline-item"><i class="fab fa-facebook-square fa-2x text-dark"></i></li></a>
            <li class="list-inline-item"><i class="fab fa-instagram fa-2x text-dark"></i></li>
          </ul>
        </div>
      </div>
      <div class="row">
